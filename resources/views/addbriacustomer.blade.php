...
<form class="form-group" action="/addbriacustomer" method="POST">
    @csrf
...
<div class="row">
  ...
  <label style="margin-left : 20px ; " for="name">Name</label>
    ...
    <label style="margin-left : 20px ; " for="VirtualPabx">Virtual Pabx</label>
  ...
  <label style="margin-left : 20px ; "  for="surname">Surname</label>
    ...
    <input style="margin-left : 20px ; width : 500px" class="form-control" type="text" name="Extensions"></br>
  </div>
</div>
